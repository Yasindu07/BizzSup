...
if(isset($_POST['add_blog'])) {
    ...
    if(empty($blog_id) || empty($blog_title) || empty($blog_content) || empty($blog_date) || empty($blog_image) ){
        ...
        $insert = "INSERT INTO blog2(bid,title,content,date,image) VALUES ('$blog_id','$blog_title',' $blog_content','$blog_date','$blog_image' )";
...
if(isset($_GET['delete'])){
    $id = $_GET['delete'];
    mysqli_query($conn, "DELETE FROM blog2 WHERE id = $id");
    header('location:blog2_panel.php');
};
?>
...
<div class ="container">
    ...
    <div class="blog-contents">
        ...
        <h3> Add new Blog </h3>
        <input type="text" placeholder ="Enter blog ID like (c_)" name ="blog_id" class ="box">
...
<?php
     ...
     $select = mysqli_query($conn,"SELECT * FROM blog2");
...
<div class ="blog-display">
              ...
              <tr>
                       ...
                       <td> 
                        ...
                        <a href="b2_update.php?edit=<?php echo $row['id']; ?>" class = "btn"> <i class="fas fa-edit"></i> edit</a>
                        <a href="blog2_panel.php?delete=<?php echo $row['id']; ?>" class = "btn"> <i class="fas fa-trash"></i>delete</a>
