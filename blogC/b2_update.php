...
if(isset($_POST['update_blog'])) {
    ...
    if(empty($blog_id) || empty($blog_title) || empty($blog_content) || empty($blog_date) || empty($blog_image) ){
        ...
        $update_data = "UPDATE blog2 SET bid ='$blog_id', title ='$blog_title', content ='$blog_content', date ='$blog_date', image ='$blog_image' WHERE id ='$id'";
...
<?php 
$select = mysqli_query($conn,"SELECT * FROM blog2 WHERE id = '$id' ");
