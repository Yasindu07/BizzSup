...
if(isset($_POST['add_blog'])) {
    ...
    if(empty($blog_id) || empty($blog_title) || empty($blog_content) || empty($blog_date) || empty($blog_image) ){
        ...
        $insert = "INSERT INTO blog3(bid,title,content,bdate,image) VALUES ('$blog_id','$blog_title',' $blog_content','$blog_date','$blog_image' )";
...
if(isset($_GET['delete'])){
    $id = $_GET['delete'];
    mysqli_query($conn, "DELETE FROM blog3 WHERE id = $id");
    header('location:blog3_panel.php');
};
?>
...
<div class ="container">
    ...
    <div class="blog-contents">
        ...
        <h3> Add new Blog </h3>
        <input type="text" placeholder ="Enter blog ID like (D_)" name ="blog_id" class ="box">
...
<?php
     ...
     $select = mysqli_query($conn,"SELECT * FROM blog3");
              ...
              <tr>
                    <!-- display input data from table -->
                       ...
                       <td> 
                        ...
                        <a href="b3_update.php?edit=<?php echo $row['id']; ?>" class = "btn"> <i class="fas fa-edit"></i> edit</a>
                        <a href="blog3_panel.php?delete=<?php echo $row['id']; ?>" class = "btn"> <i class="fas fa-trash"></i>delete</a>
