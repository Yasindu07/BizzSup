...
if(isset($_POST['add_blog'])) {
    ...
    if(empty($blog_id) || empty($blog_title) || empty($blog_content) || empty($blog_date) || empty($blog_image) ){
        ...
        $insert = "INSERT INTO blog4 (bid,btitle,bcontent,bdate,bimage) VALUES ('$blog_id','$blog_title',' $blog_content','$blog_date','$blog_image' )";
...
if(isset($_GET['delete'])){
    $id = $_GET['delete'];
    mysqli_query($conn, "DELETE FROM blog4 WHERE id = $id");
...
<div class ="container">
    ...
    <div class="blog-contents">
        ...
        <h3> Add new Blog </h3>
        <input type="text" placeholder ="Enter blog ID like (E_)" name ="blog_id" class ="box">
...
<?php
     ...
     $select = mysqli_query($conn,"SELECT * FROM blog4");
...
<div class ="blog-display">
              ...
              <tr>
                       ...
                       <td><img src="uploaded_image/<?php echo $row['bimage']; ?>" height="150" width = "150" alt =""> </td>
                       <td><?php echo $row['btitle']; ?> </td>
                       <td><?php echo $row['bcontent']; ?> </td>
                       <td><?php echo $row['bdate']; ?>  </td>
                       <td> 
                        <a href="b4_update.php?edit=<?php echo $row['id']; ?>" class = "btn"> <i class="fas fa-edit"></i> edit</a>
                        <a href="blog4_panel.php?delete=<?php echo $row['id']; ?>" class = "btn"> <i class="fas fa-trash"></i>delete</a>
